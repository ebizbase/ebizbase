...
describe('EbbAPIAuthenticateInterceptor', () => {
  ...
  let authenticate: jest.Mocked<Authenticate>;
  let domain: jest.Mocked<DomainName>;
  ...
  beforeEach(() => {
    ...
    domain = { RootDomain: 'example.com' } as jest.Mocked<DomainName>;

    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule],
      providers: [
        { provide: Authenticate, useValue: authenticate },
        { provide: DomainName, useValue: domain },
        {
